...
[Ce lien est une procédure pour l'installation et la configuration d'un serveur DNS.](article::/services-web/bind9-sous-debian-10-buster) Les parties suivantes montrent la configuration pour notre situation :
